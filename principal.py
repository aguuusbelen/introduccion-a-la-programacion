...
def main():
        ...
        archivo= open("silabas2silabas.txt","r")
        lectura(archivo, listaDeSilabas)

        archivo2= open("lemario.txt","r")
        lectura(archivo2, lemario)

        dibujar(screen, candidata, silabasEnPantalla, posiciones, Puntaje,segundos)
        ...
        # 1 frame cada 1/fps segundos
            ...
            for e in pygame.event.get():
                ...
                if e.type == KEYDOWN:
                    ...
                    if e.key == K_RETURN:
                        Puntaje += procesar(candidata, silabasEnPantalla, posiciones, lemario)
                        candidata = ""
